        ...
        link: function(scope, element, attrs){
            ...
            function getPagination(){
                ...
                if(scope.conf.rememberPerPage){
                    //console.log('rememberPerPage:'+scope.conf.rememberPerPage);
                    ...
                    //console.log('itemsPerPage:'+scope.conf.itemsPerPage);
                ...
                // 如果itemsPerPage在不在perPageOptions数组中，就把itemsPerPage加入这个数组中
                if(!perPageOptionsStatus && scope.conf.itemsPerPage && scope.conf.itemsPerPage != ''){
